...
// ✅ IMPORTANT: absolute OG image URL
const ogImage = `${canonicalUrl}/Details/linkPreviewNext.png`
...
// ✅ FIXED METADATA (THIS IS WHAT FACEBOOK READS)
export const metadata: Metadata = {
  metadataBase: new URL(canonicalUrl),
...
// ✅ FINAL CLEAN LAYOUT (NO <head> HERE)
export default function RootLayout({
  children,
}: {
  children: React.ReactNode
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.variable} ${greatVibes.variable} ${imperialScript.variable} ${cinzel.variable} font-inter antialiased`}
      >
